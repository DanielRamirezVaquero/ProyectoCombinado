...
public class GestionClientesIGU extends javax.swing.JFrame {
    ...
    // Muestra una ventana de aceptar/cancelar y devuelve true si le diÃ³ a aceptar
    private boolean muestraVentanaAceptarCancelar(String mensaje) {
        int result = JOptionPane.showConfirmDialog(this, mensaje, "Confirme la acciÃ³n", JOptionPane.OK_CANCEL_OPTION);
        return (result == 0);
    }
